      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
          ...
          <div className="p-6 sm:px-8">
            ...
            <ul className="mt-2 space-y-2 sm:mt-4">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700">Customizable hour package</span>
              </li>
              <li className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="divide-y divide-gray-200 glassmorphism rounded-2xl border border-gray-200 shadow-sm">
          ...
          <div className="p-6 sm:px-8">
            ...
            <ul className="mt-2 space-y-2 sm:mt-4">
              <li className="flex items-center gap-1">
                <span className="text-gray-700"> Everything Starter plus</span>
              </li>
              <li className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> High speed Gaming PC </span>
              </li>
              <li className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="p-6 sm:px-8">
            ...
            <ul className="mt-2 space-y-2 sm:mt-4">
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700">Trained person to assist</span>
              </li>
              <li className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-gray-700"> Extra hgh Graphics </span>
              </li>
            </ul>
          </div>
        </div>
