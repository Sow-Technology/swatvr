...
const Features = () => {
  return (
    <div className="relative w-full z-10 ">
      <section className="mx-auto max-w-7xl z-20  px-4 py-12 text-slate-100 pb-20 mb-32">
        <div className="mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end md:px-8 z-[10]">
          ...
          <BounceCard className="col-span-12 md:col-span-4">
            ...
            <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-violet-400 to-indigo-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
              <span className="block text-center font-semibold text-indigo-50">
                ...
                an unparalleled journey into virtual realms.
              </span>
            </div>
          </BounceCard>
          <BounceCard className="col-span-12 md:col-span-8">
            ...
            <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-amber-400 to-orange-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
              <span className="block text-center font-semibold text-orange-50">
                ...
                interaction for an exceptional virtual reality experience.
              </span>
            </div>
          </BounceCard>
        </div>
          ...
          <BounceCard className="col-span-12 md:col-span-8">
            ...
            <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-green-400 to-emerald-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
              <span className="block text-center font-semibold text-emerald-50">
                ...
                ready to assist you throughout your virtual reality journey.
              </span>
            </div>
          </BounceCard>
          <BounceCard className="col-span-12 md:col-span-4">
            ...
            <div className="absolute bottom-0 left-4 right-4 top-24 translate-y-8 rounded-t-2xl bg-gradient-to-br from-pink-400 to-red-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
              <span className="block text-center font-semibold text-red-50">
                ...
                Our plans cater to every adventure, ensuring maximum enjoyment.
              </span>
            </div>
          </BounceCard>
        </div>
